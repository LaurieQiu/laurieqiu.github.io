...
Also have a bit of interaction with unfamiliar people today, which surprisingly lift me up. 

To give it some context, I have some boring tasks to do today, it's also quite mindless, so much so that I can blast rock and roll with earphone while doing the copy and paste. Then came the face to face meeting, which was a bit awkward (so I decided to leave it as abstract as that), but played the magic of lifting me up. 
